...
- [ ] Kurulan dosyanın adı `Makaytron-Etsy-Keyword-Market-Analyzer.user.js`, ürün adı **Makaytron Etsy Keyword & Market Analyzer**, sürümü `1.0.4`.
...
- [ ] Marketplace Insights'ta sağ kenardaki beyaz Makaytron logolu açıcı, ürün adı, `v1.0.4`, TR/EN ve erişilebilir durum metni görünüyor.
...
- [ ] Yeni sürüm uyarısındaki **Güncelle** eylemi, denetlenen 40 karakterlik GitHub commit SHA'sına sabitlenmiş exact Keyword Analyzer `.user.js` dosyasını açıyor; Tampermonkey önizlemesinde ürün adı ve sürüm `1.0.3` görünüyor.
