...
- [ ] Installed file is `Makaytron-Etsy-Keyword-Market-Analyzer.user.js`, product name is **Makaytron Etsy Keyword & Market Analyzer**, and version is `1.0.4`.
...
- [ ] Marketplace Insights shows the white Makaytron-logo launcher on the right edge, product name, `v1.0.4`, TR/EN control, and accessible status text.
