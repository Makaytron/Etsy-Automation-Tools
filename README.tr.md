...
| [Makaytron Etsy Listing Analyzer](./scripts/etsy-listing-analyzer/README.md) | 1.2.1 | Tüm sayfaları sırayla toplar, Etsy metrik kapsamını doğrular; aktif dönem analizi, bağlamlı kohortlar, exact deney aralıkları, veri-kaliteli grafikler, AI karşılaştırması ve Health Engine sunar. |
