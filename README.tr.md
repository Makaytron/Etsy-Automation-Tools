...
| [Makaytron Etsy Message Assistant](./scripts/etsy-message-assistant/README.md) | 1.1.1 | Mesaj çevirisi, cevap taslağı, yorum talebi uygunluk kontrolü, rehberli gönder-ve-sonrakine-geç akışı, şablon ve kullanıcı tarafından seçilen AI sağlayıcıları sunar. |
