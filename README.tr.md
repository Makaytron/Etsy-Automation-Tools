...
| [Makaytron Etsy Message Assistant](./scripts/etsy-message-assistant/README.md) | 1.2.6 | Rol ayrımlı konuşma çevirisi, doğrulamalı hızlı cevaplar ve yorum cevap taslakları sunarken açık opt-in ile alıcıları tek tek işleyen Otopilotu korur. |
