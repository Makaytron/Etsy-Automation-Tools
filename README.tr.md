...
| [Makaytron Etsy Message Assistant](./scripts/etsy-message-assistant/README.md) | 1.2.0 | Kalıcı görüntüleme dili seçicili çevrilmiş gelen kutusu önizlemesi, cevap taslağı, yorum talebi uygunluk kontrolü, rehberli gönder-ve-sonrakine-geç akışı, şablon ve kullanıcı tarafından seçilen AI sağlayıcıları sunar. |
