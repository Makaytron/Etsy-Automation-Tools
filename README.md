...
| [Makaytron Etsy Listing Analyzer](./scripts/etsy-listing-analyzer/README.en.md) | 1.2.0 | Collects every page in order, verifies Etsy metric scopes, and adds active-epoch analysis, context-aware cohorts, exact experiment intervals, charts, AI comparison, and Health Engine workflows. |
