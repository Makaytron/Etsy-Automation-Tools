...
| [Makaytron Etsy Message Assistant](./scripts/etsy-message-assistant/README.en.md) | 1.0.4 | Provides translation, reply drafts, review-request eligibility controls, guided send-and-next, templates, and user-selected AI provider profiles. |
