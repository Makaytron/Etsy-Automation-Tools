...
(function () {
    ...
    function ensureInlineStyles() {
        ...
        style.textContent = `
            .ekma-inline{display:flex;align-items:center;flex-wrap:wrap;gap:4px 7px;width:max-content;max-width:100%;margin-top:6px;padding:5px 7px;box-sizing:border-box;border:1px solid #dedede;border-radius:10px;background:#fff;color:#171717;font:600 10.5px/1.25 Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;font-variant-numeric:tabular-nums;box-shadow:0 1px 2px rgba(0,0,0,.035)}
            .ekma-inline__brand{width:18px;height:18px;display:inline-grid;place-items:center;flex:0 0 auto;border:1px solid #cfcfcf;border-radius:7px;background:#f2f2f2;color:#171717;font-size:9px;font-weight:800;line-height:1}
            ...
            .ekma-inline__metric b{color:#595959;font-size:8.5px;font-weight:760;letter-spacing:.035em;text-transform:uppercase}
        ...
        mount() {
            ...
            shadow.innerHTML = `
                <style>
                    ...
                    .launcher{position:fixed;right:0;top:148px;z-index:2147483000;width:62px;height:52px;padding:0;border:1px solid var(--ekma-border);border-right:0;border-radius:14px 0 0 14px;background:#fff;color:#171717;box-shadow:0 12px 30px rgba(0,0,0,.14);cursor:pointer;display:flex;align-items:center;justify-content:center}.launcher:hover{background:var(--ekma-muted)}.launcher:focus-visible{outline:0;box-shadow:var(--ekma-focus)}.launcher-logo{display:block;width:43px;height:auto;object-fit:contain}
                    .panel{position:fixed;z-index:2147483000;top:12px;right:12px;bottom:12px;width:min(440px,calc(100vw - 24px));overflow:auto;overscroll-behavior:contain;box-sizing:border-box;padding:0 14px 14px;border:1px solid var(--ekma-border);border-radius:var(--ekma-radius-lg);background:var(--ekma-bg);color:var(--ekma-fg);box-shadow:var(--ekma-shadow);font:500 12.5px/1.45 Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;scrollbar-gutter:stable}.panel[hidden],[hidden]{display:none!important}
                    .head{position:sticky;top:0;z-index:2;display:grid;grid-template-columns:48px minmax(0,1fr) auto;align-items:center;gap:10px;margin:0 -14px 14px;padding:10px 12px 10px 14px;border-bottom:1px solid var(--ekma-border);background:#fff}.logo{width:43px;height:32px;object-fit:contain}.identity{min-width:0}.identity strong,.identity small{display:block}.identity strong{overflow:hidden;color:#171717;font-size:14px;font-weight:760;letter-spacing:-.015em;line-height:1.22;text-overflow:ellipsis}.identity small{margin-top:3px;overflow:hidden;color:var(--ekma-muted-fg);font-size:10.5px;line-height:1.25;text-overflow:ellipsis;white-space:nowrap}.version{display:inline-flex;height:22px;margin-top:5px;padding:0 8px;align-items:center;border:1px solid var(--ekma-border);border-radius:var(--ekma-radius-pill);background:var(--ekma-muted);color:#404040;font-size:10px;font-weight:700}.head-controls{display:flex;align-items:center;gap:5px}.lang,.close{min-width:32px;height:32px;padding:0;border:1px solid var(--ekma-border);border-radius:var(--ekma-radius-sm);background:#fff;color:#525252;cursor:pointer;display:inline-flex;align-items:center;justify-content:center}.lang{width:auto;padding:0 7px;font:750 10px/1 Inter,system-ui,sans-serif;letter-spacing:.04em}.lang[aria-pressed="true"]{border-color:#1f1f1f;background:#1f1f1f;color:#fff}.close{font:400 21px/1 Inter,system-ui,sans-serif}.lang:hover,.close:hover{background:#f5f5f5;color:#171717}.lang[aria-pressed="true"]:hover{background:#303030;color:#fff}.lang:focus-visible,.close:focus-visible{outline:0;box-shadow:var(--ekma-focus)}
                    .field{display:block;margin-bottom:11px}.field span{display:block;margin-bottom:6px;color:#404040;font-size:11.5px;font-weight:700}.field input,.field textarea{width:100%;box-sizing:border-box;border:1px solid var(--ekma-input);border-radius:var(--ekma-radius-sm);outline:none;background:#fff;color:#171717;padding:9px 10px;font:12.5px/1.4 Inter,system-ui,sans-serif;transition:border-color .15s,box-shadow .15s}.field input{height:40px}.field textarea{min-height:112px;resize:vertical;font:10.5px/1.45 ui-monospace,SFMono-Regular,Consolas,monospace}.field input:focus,.field textarea:focus{border-color:#525252;box-shadow:var(--ekma-focus)}.help{display:block;margin:-4px 0 10px;color:var(--ekma-muted-fg);font-size:10.5px;line-height:1.42}
                    .actions{display:grid;grid-template-columns:1fr 1fr;gap:8px}.actions button,.updates button{min-height:38px;padding:0 11px;border:1px solid var(--ekma-input);border-radius:var(--ekma-radius-sm);background:#fff;color:#171717;box-shadow:0 1px 2px rgba(0,0,0,.04);font:650 11.5px/1.2 Inter,system-ui,sans-serif;cursor:pointer}.actions button:hover,.updates button:hover{border-color:#b8b8b8;background:#f5f5f5}.actions .primary{border-color:var(--ekma-primary);background:var(--ekma-primary);color:var(--ekma-primary-fg)}.actions .primary:hover{background:#303030}.actions [data-action="cancel"],.actions [data-action="clear-data"]{border-color:#efb4ae;color:var(--ekma-danger)}.actions [data-action="cancel"]:hover,.actions [data-action="clear-data"]:hover{background:var(--ekma-danger-soft)}.actions button:focus-visible,.updates button:focus-visible{outline:0;box-shadow:var(--ekma-focus)}
                    .status,.update-banner{margin-top:11px;padding:11px 12px;border:1px solid var(--ekma-border);border-radius:var(--ekma-radius-md);background:#fff;box-shadow:0 1px 2px rgba(0,0,0,.025);color:#404040;font-size:10.5px;line-height:1.45}.update-banner{background:#fff;color:#303030}.updates{display:flex;flex-wrap:wrap;gap:7px;margin-top:9px}.updates button{min-height:32px;padding:0 9px;font-size:10.5px}.count,.source{margin-top:9px;color:var(--ekma-muted-fg);font-size:10.5px}
