...
1. Analyzer, gerçek listing ID’si yerine `L001`, v1.0.0 varsayılanı olarak tek seed keyword ve başlık/etiket SHA-256 özetini kendi sınırlandırılmış GM deposunda 10 dakika saklar.
