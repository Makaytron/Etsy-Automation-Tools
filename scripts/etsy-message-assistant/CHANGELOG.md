...
- Merkezi Mesaj Paneli ayarlarındaki mağaza kimliği placeholder'ı artık gerçek bir mağaza adını örnek olarak göstermiyor; public dağıtım yalnız sentetik xample-shop örneğini kullanıyor.
